...
PRVM_DECLARE_clientfieldfloat(voidgroup)
...
PRVM_DECLARE_clientfunction(voip_event)
PRVM_DECLARE_clientfunction(voip_echo_test)
PRVM_DECLARE_clientfunction(voip_talk)
...
PRVM_DECLARE_field(voipgroup)
PRVM_DECLARE_field(voiplistengroup)
...
PRVM_DECLARE_function(voip_event)
PRVM_DECLARE_function(voip_echo_test)
PRVM_DECLARE_function(voip_talk)
...
PRVM_DECLARE_menufunction(voip_echo_test)
...
PRVM_DECLARE_serverfieldfloat(voipgroup)
PRVM_DECLARE_serverfieldfloat(voiplistengroup)
...
PRVM_DECLARE_serverfunction(voip_event)
